...
6. Оберніть весь форматований опис у HTML-теги для правильного відображення на Shopify. Використовуйте відповідні теги, обмежтесь <div>, <p>, <strong>, <ul> та <li> для форматування. Переконайтесь, що вихідний текст є стислим та відповідає обмеженню по кількості токенів.
`.trim();
